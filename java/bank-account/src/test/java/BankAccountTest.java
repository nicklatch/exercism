...
public class BankAccountTest {
    ...
    public void cannotCheckBalanceOfClosedAccount() throws BankAccountActionInvalidException {
        ...
        assertThatExceptionOfType(BankAccountActionInvalidException.class).isThrownBy(bankAccount::getBalance).withMessage("Account closed");
    }
    ...
    public void cannotDepositIntoClosedAccount() throws BankAccountActionInvalidException {
        ...
        assertThatExceptionOfType(BankAccountActionInvalidException.class).isThrownBy(() -> bankAccount.deposit(50)).withMessage("Account closed");
    }
    ...
    public void cannotWithdrawFromClosedAccount() throws BankAccountActionInvalidException {
        ...
        assertThatExceptionOfType(BankAccountActionInvalidException.class).isThrownBy(() -> bankAccount.withdraw(50)).withMessage("Account closed");
    }


    @Test
    public void cannotCloseAnAccountThatWasNotOpened() {
        assertThatExceptionOfType(BankAccountActionInvalidException.class).isThrownBy(bankAccount::close).withMessage("Account not open");
    }
    ...
    public void cannotOpenAnAlreadyOpenedAccount() throws BankAccountActionInvalidException {
        ...
        assertThatExceptionOfType(BankAccountActionInvalidException.class).isThrownBy(bankAccount::open).withMessage("Account already open");
    }
    ...
    public void cannotWithdrawMoreThanWasDeposited() throws BankAccountActionInvalidException {
        ...
        assertThatExceptionOfType(BankAccountActionInvalidException.class).isThrownBy(() -> bankAccount.withdraw(50)).withMessage("Cannot withdraw more money than is currently in the account");
    }
    ...
    public void cannotWithdrawNegativeAmount() throws BankAccountActionInvalidException {
        ...
        assertThatExceptionOfType(BankAccountActionInvalidException.class).isThrownBy(() -> bankAccount.withdraw(-50)).withMessage("Cannot deposit or withdraw negative amount");
    }
    ...
    public void cannotDepositNegativeAmount() throws BankAccountActionInvalidException {
        ...
        assertThatExceptionOfType(BankAccountActionInvalidException.class).isThrownBy(() -> bankAccount.deposit(-50)).withMessage("Cannot deposit or withdraw negative amount");
    }
