...
public class SquareRootTest {
  ...
  public void squareRootOf1() {
    assertThat(new SquareRoot().squareRoot(1)).isEqualTo(1);
  }
  ...
  public void squareRootOf4() {
    assertThat(new SquareRoot().squareRoot(4)).isEqualTo(2);
  }
  ...
  public void squareRootOf25() {
    assertThat(new SquareRoot().squareRoot(25)).isEqualTo(5);
  }
  ...
  public void squareRootOf81() {
    assertThat(new SquareRoot().squareRoot(81)).isEqualTo(9);
  }
  ...
  public void squareRootOf196() {
    assertThat(new SquareRoot().squareRoot(196)).isEqualTo(14);
  }
  ...
  public void squareRootOf65025() {
    assertThat(new SquareRoot().squareRoot(65025)).isEqualTo(255);
  }
}
